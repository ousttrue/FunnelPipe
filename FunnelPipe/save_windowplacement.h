...
namespace nlohmann {
template <> struct adl_serializer<RECT> {
...
template <> struct adl_serializer<WINDOWPLACEMENT> {
...
template <> struct adl_serializer<windowplacement::Configuration> {
...
inline void Save(HWND hWnd, const char *config_file) {
